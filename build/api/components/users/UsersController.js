        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [2 /*return*/, res.status(500).json({ message: 'Error occured while creating new user', error: err, success: false })];
                                    case 1:
                                        _a.trys.push([1, 4, , 5]);
                                    ...
                                    case 4:
                                        err_2 = _a.sent();
                                        res.status(500).json({ message: 'Error occured while saving new user in database', error: err_2, success: false });
                                        return [3 /*break*/, 5];
                    ...
                    case 2:
                        err_1 = _a.sent();
                        res.status(500).json({ message: 'Create user service unavailable', error: err_1.message, success: false });
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        bcrypt.compare(req.body.password, user_2[0].password, function (err, result) {
                            ...
                            if (result) {
                                ...
                                res.status(200).json({ message: 'Auth succesfull', token: token, success: true });
                                return;
                            }
                    ...
                    case 2:
                        err_3 = _a.sent();
                        res.status(500).json({ message: 'Login service unavailable', error: err_3.message, success: false });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
