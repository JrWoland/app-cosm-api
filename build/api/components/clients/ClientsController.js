...
var ClientService = require('./ClientsService');
var ClientController = /** @class */ (function () {
    function ClientController() {
    }
    ClientController.prototype.getClientsList = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, clientList, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userData.userId;
                        return [4 /*yield*/, ClientService.getClientsList(userId)];
                    case 1:
                        clientList = _a.sent();
    ...
    ClientController.prototype.getClient = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, clientId, client, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, ClientService.getClient(userId, clientId)];
                    case 1:
                        client = _a.sent();
    ...
    ClientController.prototype.addClient = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, body, client, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userData.userId;
                        body = req.body;
                        return [4 /*yield*/, ClientService.addClient(userId, body)];
                    case 1:
                        client = _a.sent();
    ...
    ClientController.prototype.removeClient = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, clientId, result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userData.userId;
                        clientId = req.params.clientId;
                        return [4 /*yield*/, ClientService.removeClient(userId, clientId)];
                    case 1:
                        result = _a.sent();
